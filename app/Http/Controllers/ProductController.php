...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('product.index')->with(['success' => '<strong>' . $product->title . '</strong> Telah disimpan']);
        } catch(\Exception $e) {
    ...
    public function update(Request $request, $id)
	{
	    ...
	    return redirect()->route('product.index')->with(['success' => '<strong>' . $product->title . '</strong> Diperbaharui']);
	}
	...
	public function destroy($id)
	{
	    ...
	    return redirect()->route('product.index')->with(['success' => '</strong>' . $product->title . '</strong> Dihapus']); // DIARAHKAN KEMBALI KEHALAMAN /product
	}
}
